...
def calculate_results(images, use_wikimedia):
...
if use_wikimedia == "Yes":
	...
	if len(collection_id) > 0:
		images = wikidata.images_in_portrait_collection(collection_wikipedia_id=collection_id)
		
		calculate_results(images, use_wikimedia)	
